...
function FeaturedCourses() {
    ...
    return (
        <div className={`px-5 sm:px-12 lg:px-16 py-16 mb-6 ${themeBg} ${themeText}`} dir={direction}>
            {/* Section Header */}
            <div className="flex items-center justify-between mb-8  max-w-6xl mx-auto">
                <h2 className={`text-3xl sm:text-4xl font-semibold ${theme === 'Dark' ? 'dark:text-white' : 'text-gray-800'}`}>{t("Featured Courses")}</h2>
                <button
